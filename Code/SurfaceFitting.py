...
def fit_with_forward_moneyness(dt, dates, money, vol,
    ...
    msg += "default 값은 weight_cut=0.5 (=50%), calendar_buffer=0.001 입니다. \n" 
    msg += "외 가격의 비중을 줄이려면 weight_cut값을 늘리고 (e.g., 0.7), \n" 
    msg += "calendar_buffer 가 충분하지 않을 경우에도 \n"
    msg += "calendar_buffer을 높게 설정해 주시면 됩니다. \n" 
    msg += "[예시: fit_with_forward_moneyness(dt, dates, money, vol, TRUE, 0.7, 0.0012)] \n"
